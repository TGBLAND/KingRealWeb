...
export const metadata = {
    ...
    description: 'Hình ảnh về các hoạt động, sự kiện của công ty Bất Động Sản Dịch Vụ',
};
...
export default function BlogsPage() {
    const blogPosts = [
        ...
        // {
        //     id: 3,
        //     image: "https://source.unsplash.com/random/800x600/?teamwork,business",
        //     quote: "Đoàn kết là sức mạnh, khi chúng ta cùng nhau hợp tác, không có mục tiêu nào là không thể đạt được."
        // },
        // {
        //     id: 4,
        //     image: "https://source.unsplash.com/random/800x600/?interior,design",
        //     quote: "Thiết kế nội thất không chỉ là về vẻ đẹp, mà còn là về cách không gian ảnh hưởng đến cảm xúc và cuộc sống của chúng ta."
        // },
        // {
        //     id: 5,
        ...
        <div className="container mx-auto py-8">
            ...
            <div className="max-w-4xl mb-10">
                <p className="text-gray-600">
                    Chào mừng bạn đến với Blogs của chúng tôi - nơi chia sẻ những hình ảnh đẹp và câu châm ngôn ý nghĩa về công ty, về cuộc sống và công việc. Hy vọng những chia sẻ này sẽ mang đến cho bạn cảm hứng và động lực mỗi ngày.
                </p>
            </div>
                    ...
                    <Card key={post.id} className="overflow-hidden hover:shadow-md transition-all">
                        <div className="relative h-64">
                            ...
                            <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center p-6">
                                <p className="text-white text-center font-medium italic">"{post.quote}"</p>
                            </div>
                        </div>
